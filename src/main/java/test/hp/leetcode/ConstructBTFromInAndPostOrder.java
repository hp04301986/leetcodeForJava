...
public class ConstructBTFromInAndPostOrder {
	...
	public TreeNode build(int postStart, int inStart, int inEnd, int[] inorder, int[] postorder) {
		...
		root.left = build(postStart - 1 - (inEnd - inIndex), inStart, inIndex-1, inorder, postorder);
